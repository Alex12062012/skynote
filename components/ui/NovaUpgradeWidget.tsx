...
export function NovaUpgradeWidget({ plan }: NovaUpgradeWidgetProps) {
  ...
  return (
    <div className="fixed bottom-5 left-5 z-30 hidden items-center gap-2 rounded-pill border border-night-border bg-night-surface/90 px-3 py-1.5 shadow-md backdrop-blur-sm sm:flex">
      <NovaCoin size={15} />
