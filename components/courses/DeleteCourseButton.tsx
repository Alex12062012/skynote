    ...
    <>
      ...
      <Modal isOpen={open} onClose={() => setOpen(false)} title="Supprimer ce cours ?">
        <p className="mb-6 font-body text-[14px] text-text-secondary dark:text-text-dark-secondary">
          Tu vas supprimer <strong className="text-text-main dark:text-text-dark-main">Â«&nbsp;{courseTitle}&nbsp;Â»</strong> ainsi que toutes ses fiches et ses QCM. Cette action est irrÃ©versible.
        </p>
